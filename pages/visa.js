...
// Dynamically import VisaHQWidget to load only on client side
const VisaHQWidget = dynamic(() => import("@/components/VisaHQWidget"), { ssr: false });
                ...
                <div className="contact-map">
                  <div class="card">
                    ...
                    <div class="card-body">
                      ...
                      by professional travelers for a hassle free procedure. </div>
                      <div class="card-body">
                       Having an updated visa is an ideal situation and as the term ideal suggests it mostly does not exist.
                    </div>
                    <div class="card-body">
