...
const aboutUs = () => {
  ...
  <section className="about-section three-image about_page animated-section section-b-space">
    <div className="animation-section">
      ...
      <div className="cross po-3" />
      <div className="round po-4" />
      <div className="round po-5" />
      <div className="round r-2 po-6" />
      <div className="round r-2 po-7" />
      <div className="round r-y po-8" />
      <div className="round r-y po-9" />
      <div className="square po-10" />
      <div className="square po-11" />
      <div className="square s-2 po-12" />
    </div>
    <div className="container">
      ...
      <div className="row">
        ...
        <div className="col-xl-5">
          <div className="about-text ps-0">
            <div>
              <div className="title-3">
              </div>
              <h2>Who we are</h2>
              <p>Jays Travel is a young and dynamic independent travel agency based in West Midlands, established in June, 2008 under the efficient leadership and guidance of our great leaders. Their rich knowledge and experiences of more than 3 decades in the respective domain has helped the company to acquire specialization and offering varied travel solutions for business and leisure travelers.
                 We aim at giving you the finest experience at the best prices along with unsurpassed services, unlike any other in the business. </p>
              <div className="buttons-about">
                <a href="#" className="btn btn-lower black-btn btn-curve">contact us</a>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="row service-section color-svg">
          ...
          <div className="service-box wow fadeInUp">
            <div>
              <div className="service-icon">
                <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 59.017 59.017" style={{enableBackground: 'new 0 0 59.017 59.017'}} xmlSpace="preserve">
                  <g id="XMLID_13_">
        ...
        <div className="col-lg-4">
          <div className="service-box wow fadeInUp">
            <div>
              <div className="service-icon">
                <svg id="Layer_1" enableBackground="new 0 0 512 512" viewBox="0 0 512 512" width={512} xmlns="http://www.w3.org/2000/svg">
        ...
        <div className="col-lg-4">
          <div className="service-box wow fadeInUp">
            <div>
              <div className="service-icon">
                <svg viewBox="0 0 512 512" width="512pt" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
