...
import {faCalendar,faCrosshairs,faLocationDot,faTimesCircle,faUser} from "@fortawesome/free-solid-svg-icons";
...
const FlightConfirmation = () => {
  ...
  const getMinMaxDate = (ageFrom, ageTo) => {   
    const minDate = new Date(today.getFullYear() - ageTo, today.getMonth(), today.getDate());
...
const infantDateRange = getMinMaxDate(0, 2);
  ...
  const initiatePayment = async () => {
    ...
    if (data && data.url && data.parameters) {
        ...
        Object.keys(data.parameters).sort().forEach(key => {
...
const checkValidation = () =>{   
  ...
  const handleApiCalls = async () => {
   ...
   debugger;
   let passenger = addPnrMultiRequset.passengerDetails?.find(p => p.isLeadPassenger === true);
...
{ airsellResults?.data?.airSellResponse[1]?.flightDetails?.length > 2 ? 
               ...
               <div className="review_box">
                 ...
                 <Row>
                   <Col md={2} className="form-group">
                     ...
                     className={errors.adults[index]?.title ? "form-control is-invalid" : "form-control"}
                     >
                   ...
                   <Col md={5} className="form-group">
                     ...
                     className={errors.adults[index]?.firstName ? "form-control is-invalid" : "form-control"}
                     />
                   ...
                   <Col md={5} className="form-group">
                     ...
                     <Input
                      ...
                      // className="form-control"               
                       ...
                       className={errors.adults[index]?.lastName ? "is-invalid" : "form-control"}
                     />
                   ...
                   <Row>
                     <Col md={6} className="form-group">
                       ...
                       <Input
                         ...
                         id="inputEmail4"                         
                         onChange={(e) =>
                           handleChange('adults', index, "email", e.target.value)
                         }
                         onBlur={(e) =>
                           handleChange('adults', index, "email", e.target.value)
                         }
                         className={errors.adults[index]?.email ? "form-control is-invalid" : "form-control"}
                       />
                     ...
                     <Col md={6} className="form-group col-md-6">
                       ...
                       <Input
                        ...
                        // className="form-control"
                         id="inputnumber"
                         onChange={(e) =>
                           handleChange('adults', index, "phone", e.target.value)
                         }
                         onBlur={(e) =>
                           handleChange('adults', index, "phone", e.target.value)
                         }
                         className={errors.adults[index]?.phone ? "form-control is-invalid" : "form-control"}
                       />
         ...
         <Row>
           <Col md={2} className="form-group">
             ...
             <Input type="select" 
              ...
              id={`title-child-${index}`}
               ...
               className={errors.children[index]?.title ? "form-control is-invalid" : "form-control"}
             >
               <option value="">Choose...</option>
           ...
           <Col md={5} className="form-group">
             ...
             <Input
               ...
               className={errors.children[index]?.firstName ? "form-control is-invalid" : "form-control"}
             />
           ...
           <Col md={5} className="form-group">
             ...
             <Input
              ...
              // className="form-control"
               ...
               className={errors.children[index]?.lastName ? "form-control is-invalid" : "form-control"}
             />
           ...
           <Col md={3} className="form-group">
                   <div className="form-group">
                   <label htmlFor={`children-dob-${index}`}>Date of Birth</label>
                   <DatePicker
         ...
         <Row>
           <Col md={2} className="form-group">
            ...
            // className="form-control" 
             ...
             className={errors.infants[index]?.title ? "form-control is-invalid" : "form-control"}
             >
               <option value="">Choose...</option>
           ...
           <Col md={5} className="form-group">
             ...
             //  value={formData['infant'][index]?.firstName}
               ...
               className={errors.infants[index]?.firstName ? "form-control is-invalid" : "form-control"}
             />
           ...
           <Col md={5} className="form-group">
             ...
             //  value={formData['infant'][index]?.lastName}               
               ...
               className={errors.infants[index]?.lastName ? "form-control is-invalid" : "form-control"}
             />
    ...
    ) : (<div> <h1>No Fare Available</h1></div>)}
